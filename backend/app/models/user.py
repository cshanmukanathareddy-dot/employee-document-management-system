...
class User(Base):
    ...
    password_reference: Mapped[str | None] = mapped_column(String(255), nullable=True, default=None)
    ...
    directory_name: Mapped[str] = mapped_column(String(100), unique=True, nullable=False, index=True)

    role: Mapped[str] = mapped_column(String(20), default="employee", nullable=False)
    status: Mapped[str] = mapped_column(String(20), default="active", nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)

    storage_limit_bytes: Mapped[int] = mapped_column(BigInteger, default=2147483648, nullable=False)
    storage_limit_gb: Mapped[float] = mapped_column(Float, default=2.0, nullable=False)
