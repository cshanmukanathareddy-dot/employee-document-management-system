...
import { formatStorageGb } from "../utils/storageHelper";
...
export default function StorageRequests() {
  ...
  const decide = async (request, decision) => {
    const label =
      decision === "approve"
        ? `approve ${formatStorageGb(request.requested_gb)} for ${request.employee_name}`
                        ...
                        <div>
                          ...
                          <div className="mt-2 grid gap-x-7 gap-y-1.5 text-xs text-slate-500 sm:grid-cols-2 lg:grid-cols-4">
                            ...
                            <span>
                              Current:{" "}
                              <strong className="text-slate-700">
                                {formatStorageGb(request.current_storage_gb)}
                              </strong>
                            </span>
                            ...
                            <span>
                              ...
                              <strong className="text-indigo-700">
                                +{formatStorageGb(request.requested_gb)}
                              </strong>
                            </span>
                          </div>
                        </div>
