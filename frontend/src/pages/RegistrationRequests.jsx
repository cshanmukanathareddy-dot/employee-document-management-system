...
import { formatStorageBytes, formatStorageGb } from "../utils/storageHelper";
            ...
            <div className="mt-2 grid gap-x-6 gap-y-1.5 text-xs text-slate-500 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <span className="inline-flex items-center gap-1.5">
                ...
                <strong className="text-indigo-700">
                  {request.storage_limit_bytes ? formatStorageBytes(request.storage_limit_bytes) : formatStorageGb(request.storage_gb)}
                </strong>
              </span>
            </div>
          </div>
